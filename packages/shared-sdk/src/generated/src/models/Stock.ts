...
export function StockToJSON(json: any): Stock {
    return StockToJSONTyped(json, false);
}

export function StockToJSONTyped(value?: Stock | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
