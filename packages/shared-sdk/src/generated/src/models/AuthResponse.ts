...
import type { AuthResponseAllOfData } from './AuthResponseAllOfData';
import {
    AuthResponseAllOfDataFromJSON,
    AuthResponseAllOfDataFromJSONTyped,
    AuthResponseAllOfDataToJSON,
    AuthResponseAllOfDataToJSONTyped,
} from './AuthResponseAllOfData';
...
export function AuthResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthResponse {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : AuthResponseAllOfDataFromJSON(json['data']),
    };
}
...
export function AuthResponseToJSONTyped(value?: AuthResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': AuthResponseAllOfDataToJSON(value['data']),
    };
}
